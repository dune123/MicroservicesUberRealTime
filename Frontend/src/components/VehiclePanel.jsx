...
const VehiclePanel = ({setConfirmRidePanel, setVehiclePanel }) => {
  return (
    <div>
      ...
      <div className="flex border-2 active:border-black  mb-2 rounded-xl w-full p-3  items-center justify-between" onClick={()=>setConfirmRidePanel(true)}>
        <img
          className="h-10"
      ...
      <div className="flex border-2 active:border-black  mb-2 rounded-xl w-full p-3  items-center justify-between" onClick={()=>setConfirmRidePanel(true)}>
        ...
        <h2 className="text-lg font-semibold">₹390</h2>
      </div>
    </div>
  );
};
